...
info = pd.read_csv(
    "C:\\Users\\Sayed\\Desktop\\Python For Finance\\Trend Template\\Fast\\Stock Screener Data\\screener-stocks.csv")


def analyse(ticker, info):
    df = pd.read_csv(f"C:\\Users\\Sayed\\Desktop\\Python For Finance\\Trend Template\\Fast\\Data\\{ticker}.csv")
    # print(df)
    last = df.iloc[-1]
